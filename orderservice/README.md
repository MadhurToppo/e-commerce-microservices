...
```
java -Dspring.profiles.active=production -jar ./build/libs/orderservice-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=com.madhurtoppo.microservices/orderservice
```
