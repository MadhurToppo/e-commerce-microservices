...
```
java -Dspring.profiles.active=production -jar ./build/libs/productservice-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=com.madhurtoppo.microservices/productservice
```
